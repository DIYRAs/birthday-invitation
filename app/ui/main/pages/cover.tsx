...
const Cover = () => {
    return (
        <section id='cover'
            ...
            className='w-full min-h-[100dvh] flex flex-col items-center justify-between md:py-20 py-10
        bg-cover bg-center gap-y-5 text-white'>
            ...
            <div className='flex flex-col items-center justify-center mb-10 gap-y-8'>
                <div style={{boxShadow: '0 0 20px gray'}}
                ...
                <Button className='px-10 py-5 rounded-full cursor-pointer'>
                    Buka Undangan
                </Button>
            </div>
